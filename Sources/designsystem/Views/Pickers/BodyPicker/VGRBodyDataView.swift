...
public struct VGRBodyDataView: View {
...
#Preview {
    ...
    NavigationStack {
        ScrollView {
            HStack {
                VGRBodyDataView(orientation: .front, selectedParts: selectedParts, strokeWidth: 0.5)
                    .frame(width: 100, height: 300)

                VGRBodyDataView(orientation: .back, selectedParts: selectedParts)
                    .frame(width: 100, height: 300)
            }
        }
        .frame(maxWidth: .infinity)
